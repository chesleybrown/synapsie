...
class FBConnect():
    ...
    def get_user_from_cookie(self, cookies, app_id, app_secret):
        ...
        if self.user is None:
            ...
            if not cookie:
                return None
            parsed_request = self.parse_signed_request(cookie, app_secret)
            if not parsed_request:
                return None
            try:
                result = self.get_access_token_from_code(parsed_request["code"], "",
                                                    app_id, app_secret)
    ...
    def parse_signed_request(self, signed_request, app_secret):
    ...
    def auth_url(self, app_id, canvas_url, perms=None, state=None):
